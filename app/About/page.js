      ...
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8 ml-4">
        <div className="col-span-2">
          ...
          <p className="py-2 text-gray-600">
            ...
            learn more,I started with basic HTML , CSS and decided to pursue my career in web development I am
            now spending my time building projects in React js , React native
            and learning new technologies. I have also learnt building
            visualization dashboards using Microsoft powerBI.
          </p>
          ...
          <p className="text-gray-600"> Hackerrank Badges -Silver level in python , Bronze level in SQL & C</p>
          <p className="text-gray-600">AWS Academy Graduate - AWS Academy Cloud Foundations</p>
        </div>
